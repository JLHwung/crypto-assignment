...
func ExampleGuessManyTimePadding() {
	...
	cracker := ManyTimePaddingInteractiveCracker{target: target, cipherTextString: cipherTextString}
	...
	fmt.Println(pt)
	// Output: The secret message is: When using a stream cipher, never use the key more than once
}
